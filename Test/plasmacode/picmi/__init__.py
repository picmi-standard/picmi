...
picmi_classes = [cls for cls in picmistandard.__dir__() if cls.startswith("PICMI_")]
...
# The name `Species` is defined in the code generation magic above:
picmistandard.PICMI_MultiSpecies.Species_class = Species  # noqa: F821


class CylindricalGrid(picmistandard.PICMI_CylindricalGrid):
    def init(self, kw):
        self.mode_phase = kw.pop("plasmacode_mode_phase", 0.0)
